// Code generated by "dbusutil-gen -type Audio,Sink,SinkInput,Source,Meter -import pkg.deepin.io/lib/dbus1 audio.go sink.go sinkinput.go source.go meter.go"; DO NOT EDIT.
...
func (v *Sink) setPropActivePort(value Port) (changed bool) {
	logger.Warningf("ActivePort : %s,value : %s",v.ActivePort,value)
...
func (v *Sink) emitPropChangedActivePort(value Port) error {
	return v.service.EmitPropertyChanged(v, "ActivePort", value) //改变activeport属性。写到文件中，然后就可以识别吗？
}
...
func (v *Audio) setPropDefaultSink(value dbus.ObjectPath) (changed bool) {  //设置默认的输出音频
	if v.DefaultSink != value {
		v.DefaultSink = value
		v.emitPropChangedDefaultSink(value)		//估计将信号传输给前端。
		return true
	}
	return false
}
