...
func (psp *powerSavePlan) addTaskNoLock(t *delayedTask) {  //延时任务.
...
func (psp *powerSavePlan) Update(screenSaverStartDelay, lockDelay,
	...
	psp.interruptTasks()
	logger.Warningf("update(screenSaverStartDelay=%vs, lockDelay=%vs,"+
...
func (psp *powerSavePlan) HandleIdleOn() {
	...
	for _, t := range psp.metaTasks {  //执行所有的task.
